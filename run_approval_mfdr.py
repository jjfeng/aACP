...
def parse_args(args):
    ...
    parser.add_argument('--mptvr',
        type=float,
        help="what is the requested modified positive to total variation",
        default=0.1)
    parser.add_argument('--alpha-use-factor',
        type=float,
        default=0.01)
    ...
    assert args.alpha_use_factor > 0
    assert args.decay >= 0 and args.decay <= 1
    return args
